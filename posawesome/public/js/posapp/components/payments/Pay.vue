    ...
    <v-row v-show="!dialog">
      <v-col md="8" cols="12" class="pb-2 pr-0">
        ...
        >
          ...
          <div
            v-if="
              pos_profile.posa_allow_reconcile_payments && unallocated_payments.length
            "
          >
            <v-row>
              <v-col md="7" cols="12">
      ...
      <v-col md="4" cols="12" class="pb-3">
        <v-card
          class="invoices mx-auto bg-grey-lighten-5 mt-3 p-3"
          style="max-height: 94vh; height: 94vh"
        >
          <strong>
              ...
              >
                ...
                <v-col md="5"
                  ><v-text-field
                    ...
                    @change="setFormatedCurrency(method, 'amount', null, true, $event)"
                    payments_methods
                    flat
                    :prefix="currencySymbol(pos_profile.currency)"
                  ></v-text-field
...
export default {
  ...
  methods: {
    ...
    fetch_customer_details() {
      console. log("Fetching customer details for:", this.customer_name);
      var vm = this;
